...
def style_lines(prefix, category_id, label, cards, obtained):
    ...
    return [
        ...
        f'exampleItemId: {cards[0]["id"] if cards else 995}',
        '*/',
        ...
        '  icon = CurrentItem();\\',
        f'  showLootbeam = {"true" if obtained and category_id in {"slayer_pvm", "clues_uniques"} else "false"};\\',
...
def generate(catalog_obj, collection):
    ...
    lines = [
        '/*@ define:module:cardcore_ownership',
        '---',
        'name: "Cardcore: Item Ownership"',
        'subtitle: "Optional Ironman visibility control"',
        'description: |',
        '  Enable this to show only items owned by you.',
        '*/',
        '',
